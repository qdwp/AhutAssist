...
Ext.define('app.util', {
    ...
    statics: {
        //加载stroe
        getStoreLoad: function (list, params) {
            ...
            store.load({
                callback: function (records, operation, success) {
                    if (records.length == 0) {
                        list.setEmptyText('恭喜您，当前学期没有缺勤记录！');
                        //util.showMessage('恭喜您，当前学期没有缺勤记录！', true);
                    }
                }
            });
        },
        ...
        recordLoad: function (record, view, url, params, ckName) {
            ...
            //    console.log(record,'ID', record.get(ckName));
            //    return;
            //}
            Ext.Ajax.request({
                url: url,
        ...
        //获取当前时间的学年学期信息 第一学期：8/21 - 2-9   第二学期：2/10 - 8/20
        getYearandTerm: function () {
            ...
            return { nvcYear: nvcYear, nvcTerm: nvcTerm };
        },
        //app初始化执行
        inIt: function () {
            this.overrideList();
