Ext.define('Index.view.IndexView_CM', {
    ...
    initComponent: function () {
            ...
            root: {
                ...
                children: [
                 ...
                 { text: '投票结果', leaf: true, linkurl: '/application/Evaluate/Vote/indexT.html', newwindows: '0', id: '1' },
                   { text: '评教统计', leaf: true, linkurl: '/application/Attendance/Count/index.html', newwindows: '0', id: '3' }
                ]
            }
        ...
        function LoadPage(record) {
            var mainview = Ext.getCmp('Index_IndexView_CM');//主视图
