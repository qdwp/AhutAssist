//全校学生考情统计
Ext.define('Attendance_Count.view.SchoolListView',
    {
        extend: 'Ext.container.Container',
        alies: 'widget.SchoolList',
        requires: [
        'Ext.grid.Panel',
...
var School_way = Ext.create('Ext.data.Store', {
    fields: ['abbr', 'name'],
    data: [
        { "abbr": "全校学生旷课", "name": "全校学生旷课" },
        { "abbr": "全校班级倒叙", "name": "全校班级倒叙" },
         { "abbr": "全校专业倒叙", "name": "全校专业倒叙" }
    ]
});