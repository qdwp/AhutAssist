Ext.define('Attendance_Count.store.CountMajorStore', {
    extend: 'Ext.data.Store',
    requires:
        [
            'Attendance_Count.model.CountMajorModel',
    ...
    constructor: function (cfg) {
        if (gbl_rolename == "校领导") {
            ...
            me.callParent([Ext.apply({
                autoLoad: true,
                model: 'Attendance_Count.model.CountMajorModel',
                remoteSort: true,
                storeId: 'CountClassStore',
                pageSize: 5,
                proxy: {
                    type: 'direct',
                    directFn: 'Attendance.Count.MajorLoad',
                    paramOrder: [
                        'start',
                        'limit',
                        'Field',
        ...
        if (gbl_rolename == "院领导") {
            ...
            me.callParent([Ext.apply({
                ...
                proxy: {
                    type: 'direct',
                    directFn: 'Attendance.Count.CollegeMajorLoad',
                    paramOrder: [
                        'start',
                        'limit',
                        'Field',
