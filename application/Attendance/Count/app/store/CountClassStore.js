Ext.define('Attendance_Count.store.CountClassStore', {
    extend: 'Ext.data.Store',
    requires:
        [
            'Attendance_Count.model.CountClassModel',
    ...
    constructor: function (cfg) {
        if (gbl_rolename == "校领导") {
            ...
            me.callParent([Ext.apply({
                autoLoad: true,
                model: 'Attendance_Count.model.CountClassModel',
                remoteSort: true,
                storeId: 'CountClassStore',
                pageSize: 5,
                proxy: {
                    type: 'direct',
                    directFn: 'Attendance.Count.ClassLoad',
                    paramOrder: [
                        'start',
                        'limit',
                        'Field',
        ...
        if (gbl_rolename == "院领导") {
            ...
            me.callParent([Ext.apply({
                ...
                proxy: {
                    type: 'direct',
                    directFn: 'Attendance.Count.CollegeClassLoad',
                    paramOrder: [
                        'start',
                        'limit',
                        'Field',
        ...
        if (gbl_rolename == "辅导员") {
            ...
            me.callParent([Ext.apply({
                ...
                proxy: {
                    type: 'direct',
                    directFn: 'Attendance.Count.AssistClassLoad',
                    paramOrder: [
                        'start',
                        'limit',
                        'Field',
