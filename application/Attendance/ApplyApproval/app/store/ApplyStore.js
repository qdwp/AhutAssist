Ext.define('Attendance_Apply.store.ApplyStore', {
    extend: 'Ext.data.Store',
    requires:
        [
            'Attendance_Apply.model.ApplyModel',
            'Ext.data.proxy.Direct',
            'Attendance_Apply.DirectAPI',
    ...
    constructor: function (cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: true,
            model: 'Attendance_Apply.model.ApplyModel',
            remoteSort: true,
            storeId: 'ApplyStore',
            pageSize: 11,
            proxy: {
                type: 'direct',
                directFn: 'Attendance.Apply.PageLoad',
                paramOrder: [
                    'start',
                    'limit',
                    'Field',
