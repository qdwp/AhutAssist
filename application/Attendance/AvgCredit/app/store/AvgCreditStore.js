Ext.define('Attendance_AvgCredit.store.AvgCreditStore', {
    extend: 'Ext.data.Store',
    requires:
        [
            'Attendance_AvgCredit.model.AvgCreditModel',
            'Ext.data.proxy.Direct',
            'Attendance_AvgCredit.DirectAPI',
    ...
    constructor: function (cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: true,
            model: 'Attendance_AvgCredit.model.AvgCreditModel',
            remoteSort: true,
            storeId: 'AvgCreditStore',
            pageSize: 20,
            proxy: {
                type: 'direct',
                directFn: 'Attendance.AvgCredit.PageLoad',
                paramOrder: [
                    'start',
                    'limit',
                    'Field',
    ...
    onDirectSoreBeforeLoad: function (store, operation, eOpts) {
        ...
        store.getProxy().setExtraParam('Direction', "DESC");
    },
