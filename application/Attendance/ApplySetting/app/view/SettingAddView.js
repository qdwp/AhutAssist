Ext.define('Attendance_Setting.view.SettingAddView', {
    extend: 'Ext.window.Window',
    alias: 'widget.SettingAdd',
    requires: [
        'Ext.form.Panel',
                       ...
                       valueField: 'value'
                         ...
                         listeners: {
                             select: function (field, value, eOpts) {
                                 var t = Ext.getCmp('MT_Add_endTime');
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        '->', {
                            xtype: 'button',
                            itemId: 'Attendance_SettingAdd_OK',
                            text: '确 定'
                        },
                        {
                            xtype: 'button',
                            itemId: 'Attendance_SettingAdd_Cancel',
                            text: '取 消'
                        }, '->'
                    ]
                }
