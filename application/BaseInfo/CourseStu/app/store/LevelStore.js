Ext.define('BaseInfo_CourseStu.store.LevelStore', {
    extend: 'Ext.data.Store',
    requires:
        [
            'BaseInfo_CourseStu.model.LevelModel',
    ...
    constructor: function (cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: true,
            model: 'BaseInfo_CourseStu.model.LevelModel',
            remoteSort: true,
            storeId: 'LevelStore',
            pageSize: 5,
            proxy: {
                type: 'direct',
                directFn: 'BaseInfo.CourseStu.EvaLoad',
                paramOrder: [
                    'start',
                    'limit',
                    'Field',
