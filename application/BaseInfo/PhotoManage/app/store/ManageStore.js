Ext.define('BaseInfo_Manage.store.ManageStore', {
    extend: 'Ext.data.Store',
    requires:
        [
            'BaseInfo_Manage.model.ManageModel',
            'Ext.data.proxy.Direct',
            'BaseInfo_Manage.DirectAPI',
    ...
    constructor: function (cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: true,
            model: 'BaseInfo_Manage.model.ManageModel',
            remoteSort: true,
            storeId: 'ManageStore',
            pageSize: 5,
            proxy: {
                type: 'direct',
                directFn: 'BaseInfo.Manage.PageLoad',
                paramOrder: [
                    'start',
                    'limit',
                    'Field',
