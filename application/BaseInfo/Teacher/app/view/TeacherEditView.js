Ext.define('BaseInfo_Teacher.view.TeacherEditView', {
                                                   ...
                                                   items: [
                                                      {
                                                          ...
                                                          name: 'nvcTeaPhoto',
                                                          id: 'BaseInfo_TeacherEdit_PhotoFiles',
                                                          readOnly: true,
                                                          labelWidth: 65
                                                      }, {
                                                          xtype: 'filefield',
                                                          ...
                                                          columnWidth: 0.1,
                                                          text: '上传',
                                                          itemId: 'BaseInfo_TeacherEdit_PhotoFilesUP'
                                                      }
                                                   ]
                                               }, {
                                                   xtype: 'combobox',
                                               ...
                                               items: [
                                                   {
                                                       xtype: 'image',
                                                       name: 'PhotoImage',
                                                       itemId: 'BaseInfo_TeacherEdit_PhotoImage',
                                                       columnWidth: 1,
                                                       height: 195,
                        ...
                        dockedItems: [
                            {
                                ...
                                items: [
                                    '->', {
                                        xtype: 'button',
                                        itemId: 'BaseInfo_TeacherEdit_OK',
                                        text: '确 定'
                                    },
                                    {
                                        xtype: 'button',
                                        itemId: 'BaseInfo_TeacherEdit_Cancel',
                                        text: '取 消'
                                    }, '->'
                                ]
                            }
