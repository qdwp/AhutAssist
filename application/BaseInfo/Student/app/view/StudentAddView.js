Ext.define('BaseInfo_Student.view.StudentAddView', {
                                        ...
                                        items: [
                                           {
                                               ...
                                               name: 'nvcStuPhoto',
                                               id: 'BaseInfo_StudentAdd_PhotoFiles',
                                               readOnly: true,
                                               labelWidth: 65
                                           }, {
                                               xtype: 'filefield',
                                               ...
                                               columnWidth: 0.1,
                                               text: '上传',
                                               itemId: 'BaseInfo_StudentAdd_PhotoFilesUP'
                                           }
                                        ]
                                    }, {
                                        xtype: 'combobox',
                                        ...
                                        items: [
                                            {
                                                xtype: 'image',
                                                name: 'PhotoImage',
                                                itemId: 'BaseInfo_StudentAdd_PhotoImage',
                                                columnWidth: 1,
                                                height: 195,
                        ...
                        dockedItems: [
                            {
                                ...
                                items: [
                                    '->', {
                                        xtype: 'button',
                                        itemId: 'BaseInfo_StudentAdd_OK',
                                        text: '确 定'
                                    },
                                    {
                                        xtype: 'button',
                                        itemId: 'BaseInfo_StudentAdd_Cancel',
                                        text: '取 消'
                                    }, '->'
                                ]
                            }
