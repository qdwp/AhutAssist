Ext.define('Evaluate_Level.store.LevelStore', {
    extend: 'Ext.data.Store',
    requires:
        [
            'Evaluate_Level.model.LevelModel',
            'Ext.data.proxy.Direct',
            'Evaluate_Level.DirectAPI',
    ...
    constructor: function (cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: true,
            model: 'Evaluate_Level.model.LevelModel',
            remoteSort: true,
            storeId: 'LevelStore',
            pageSize: 5,
            proxy: {
                type: 'direct',
                directFn: 'Evaluate.Level.PageLoad',
                paramOrder: [
                    'start',
                    'limit',
                    'Field',
