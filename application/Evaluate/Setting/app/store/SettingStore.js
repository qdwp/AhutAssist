Ext.define('Evaluate_Setting.store.SettingStore', {
    extend: 'Ext.data.Store',
    requires:
        [
            'Evaluate_Setting.model.SettingModel',
            'Ext.data.proxy.Direct',
            'Evaluate_Setting.DirectAPI',
    ...
    constructor: function (cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: true,
            model: 'Evaluate_Setting.model.SettingModel',
            remoteSort: true,
            storeId: 'SettingStore',
            pageSize: 5,
            proxy: {
                type: 'direct',
                directFn: 'Evaluate.Setting.PageLoad',
                paramOrder: [
                    'start',
                    'limit',
                    'Field',
